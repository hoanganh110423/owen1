            ...
            <div class="container">
                <div class="menu-ba-container">
                    <ul>
                        ...
                        <li><a href="/owen/trangchusn.php" style="color: #333;">CỬA HÀNG</a></li>
            ...
            <div class="slider-bar-now">
                ...
                <div class="slider-bar-now-colum3-item">
                    <form action="/owen/addtocart.php" method="post">
                        ...
                        <li><span>599.000</span><sup>đ</sup></li>
                        ...
                        <input type="hidden" name="gia" value="599000">
            ...
            <div class="fage-footer-container-now-colum1">
                <div class="fage-footer-container-now-colum1-item">
                    <h4 class="footer-logo">
                        <a title="Owen" href="/owen/trangchusn.php"><img src="/owen/image/logoowen.webp" alt="logo" style="width: 150px;height: 50px;"></a>
                    </h4>
