            ...
            <div class="container">
                <div class="menu-ba-container">
                    <ul>
                        ...
                        <li><a href="/owen/php/quan.php" style="color: #333;"> QUẦN</a>
                            <div class="submenu2">
                                <ul>
                                    ...
                                    <li><a href="/owen/phpquan.php">Quần khaki</a></li>
                        ...
                        <li><a href="/owen/admin/tranglogon.php"><i class="fas fa-heart"></i></a></li>
...
<div class="slider-bar-now-colum3-item">
    <form action="/owen/addtocart.php" method="post">
        ...
        <li><span>699.000</span><sup>đ</sup></li>
        ...
        <input type="hidden" name="gia" value="699000">
