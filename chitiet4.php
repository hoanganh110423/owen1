...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='css/chitiet.css'>
            ...
            <div class="container">
                <div class="menu-ba-container">
                    <ul>
                        ...
                        <li><a href="viewcart.php"><i class="fas fa-cart-plus"></i></a></li>
                    </ul>
                </div>
            </div>
        </section>
            ...
            <div class="slider-bar-now">
                <div class="slider-bar-now-colum1">
                    <div class="slider-bar-now-colum1-item">
                        <h1><a href="giatot.html">Giá tốt</a></h1>
                            <ul>
                                <li><a href="ao.html">Polo-tshirt</a></li>
                                <li><a href="quan.html">Quần giá tốt</a></li>
                                <li><a href="ao.html">Áo sơ mi</a></li>
                            </ul>
                        <h1><a href="ao.html">Áo</a></h1>
                            <ul>
                                <li><a href="ao.html">Áo Polo</a></li>
                                <li><a href="ao.html">Áo Sơ Mi</a></li>
                                <li><a href="ao.html">Áo Thun</a></li>
                                <li><a href="ao.html">Áo Len</a></li>
                            </ul>
                        <h1><a href="quan.html">Quần</a></h1>
                            <ul>
                                <li><a href="quan.html">Quần Tây</a></li>
                                <li><a href="quan.html">Quần Khaki</a></li>
                                <li><a href="quan.html">Quần Jeansjeans</a></li>
                                <li><a href="quan.html">Quần Jogger</a></li>
                            </ul>
                        <h1><a href="phukien.html">Phụ Kiện</a></h1>
                            <ul>
                                <li><a href="phukien.html">Tất</a></li>
                                <li><a href="phukien.html">Thắt Lưng</a></li>
                                <li><a href="phukien.html">Ví</a></li>
                                <li><a href="phukien.html">Cà vạt</a></li>
                            </ul>
                    </div>
                ...
                <div class="slider-bar-now-colum2-item">
                    <div class="slider-bar-now-colum2-item-1">
                        <img src="image/ct4.1.webp" alt="">
                        <div class="slider-bar-now-colum2-item-1-text">
                        </div>
                        <div class="slider-bar-now-colum2-item-1-text2">
                            <ul>
                                <li><img src="image/ct4.2.jpg" alt=""></li>
                                <li><img src="image/ct4.3.jpg" alt=""></li>
                                <li><img src="image/ct4.4.jpg" alt=""></li>
                            </ul>
                ...
                <div class="slider-bar-now-colum3-item">
                    <form action="addtocart.php" method="post">
                        ...
                        <input type="hidden" name="img" value="image/ct4.1.webp">
    ...
    <section class="product-gallrey-1">
        <div class="container">
            ...
            <div class="salebackground">
                <img src="image/owen giảm giá.webp" alt="">
            </div>
        </div>
    </section>
    <!---------------fage footer----------------->
