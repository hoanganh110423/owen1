            ...
            <div class="slider-bar-now">
                ...
                <div class="slider-bar-now-colum2-item">
                    <div class="slider-bar-now-colum2-item-1">
                        ...
                        <div class="slider-bar-now-colum2-item-1-text2">
                            <ul>
                                <li><img src="/owen/image/ao3.webp" alt=""></li>
                                <li><img src="/owen/image/ao1.webp" alt=""></li>
                                <li><img src="/owen/image/ao2.webp" alt=""></li>
                            </ul>
                ...
                <div class="slider-bar-now-colum3-item">
                    <form action="/owen/addtocart.php" method="post">
                        ...
                        <input type="hidden" name="img" value="/owen/image/ao1.webp">
        ...
        <div class="fage-footer-container-now">
            ...
            <div class="fage-footer-container-now-colum2">
                <div class="fage-footer-container-now-colum2-item">
                    ...
                    <ul class="footer-links ">
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Giới thiệu</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">BLOG</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Hệ thống của hàng</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Liên hệ OWEN</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Chính sách bảo mật</a></li>
                    </ul>
                </div>
            </div>
            <div class="fage-footer-container-now-colum3">
                <div class="fage-footer-container-now-colum3-item">
                    ...
                    <ul class="footer-links ">
                        <li><a title="owen" href="gioithieu.php" style="color:#060709;">Hỏi đáp</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Chính sách vận chuyển</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Hướng dẫn chọn kích cỡ</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Hướng dẫn thanh toán</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Quy định đổi hàng</a></li>
                        <li><a title="owen" href="gioithieu.php"style="color:#060709;">Hướng dẫn mua hàng</a></li>
                    </ul>
                </div>
            </div>
