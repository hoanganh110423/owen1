...
<body>
    ...
    <img src="/owen/image/sliderpk.jpg" style="width: 85%; padding: 10px; margin: 30px 110px; object-fit: cover;">
                            ...
                            <div class="product-gallrey-1-container-product">
                                <div class="product-gallrey-1-container-product-1">
                                    ...
                                    <div class="product-gallrey-1-container-product-1-text">
                                        <li>ÁO SƠ MI</li>
                                        <!--<li><span>150.000</span><sup>đ</sup></li>-->
                                    </div>
                                </div>
                                <div class="product-gallrey-1-container-product-1">
                                    <a href="/owen/php/chitiet.php">
                                    ...
                                    <div class="product-gallrey-1-container-product-1-text">
                                        <li>ÁO SƠ MI NAM </li>
                                        <!--<li><span>100.000</span><sup>đ</sup></li>-->
                                    </div>
                                </div>
                                <div class="product-gallrey-1-container-product-1">
                                    <a href="/owen/php/chitiet.php">
                                ...
                                <div class="product-gallrey-1-container-product-1">
                                    ...
                                    <div class="product-gallrey-1-container-product-1-text">
                                        <li>ÁO POLO </li>
                                        <!--<li><span>120.000</span><sup>đ</sup></li>-->
                                    </div>
                                </div>
                                <div class="product-gallrey-1-container-product-1">
                                    <a href="/owen/php/chitiet.php">
                                    ...
                                    <div class="product-gallrey-1-container-product-1-text">
                                        <li>QUẦN TÂY 1 </li>
                                        <!--<li><span>130.000</span><sup>đ</sup></li>-->
                                    </div>
                                </div>
                                <div class="product-gallrey-1-container-product-1">
                                    <a href="/owen/php/chitiet.php">
                                    ...
                                    <div class="product-gallrey-1-container-product-1-text">
                                        <li>QUẦN TÂY 2</li>
                                        <!--<li><span>90.000</span><sup>đ</sup></li>-->
                                    </div>
                                </div>
                                <div class="product-gallrey-1-container-product-1">
                                    <a href="/owen/php/chitiet.php">
